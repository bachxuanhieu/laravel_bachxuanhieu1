...
@section('title','Admin orders Details')   
                ...
                <div class="card-header">
                   <h4 class="text-primary">
                        ...
                        <a href="{{url('admin/invoice/'.$order->id)}}" target="_blank" class="btn btn-warning btn-sm float-end mx-1">
                           <span class="fa fa-eye"> View Invoice
                        </a>
                        <a href="{{url('admin/invoice/'.$order->id.'/mail')}}" target="_blank" class="btn btn-info btn-sm float-end mx-1">
                           Send Gmail
                       </a>   
                   </h4>
                </div>
                   ...
                   <div class="row">
                      <div class="col-md-6">
                         ...
                         <h6 class="border p-2 text-success">
                            Order Status Message: <span class="text-danger">{{$order->status_message}}</span>
                         </h6>
                      </div>
                      <div class="col-md-6">
                         <h5>User Details</h5>
                         ...
                         <tbody>
                            ...
                            <tr>
                               ...
                               <td width="10%">
                                  ...
                                  <img src="{{$orderItem->product->productImages[0]->image}}" 
                               ...
                               <td width="10%">{{ $orderItem->quanlity }}</td>
                               <td width="10%" class="fw-bold">${{ $orderItem->quanlity * $orderItem->price }}</td>
                               @php
                               $totalPrice += $orderItem->quanlity * $orderItem->price;
                               @endphp
                            </tr>
                            @empty
                            <tr>
