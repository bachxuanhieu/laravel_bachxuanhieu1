               ...
               <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade border p-3 show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                     ...
                     <div class="mb-3">
                        ...
                        <textarea name="small_description" value="" class="form-control" id=""  rows="4">{{$product->small_description}}</textarea>
                     </div>
                     <div class="mb-3">
                  ...
                  <div class="tab-pane fade  border p-3" id="seotag" role="tabpanel" aria-labelledby="seotag-tab">
                     ...
                     <div class="mb-3">
                        ...
                        <textarea name="meta_keyword" class="form-control" id=""  rows="4">{{$product->meta_keyword}}</textarea>
                     </div>
                     <div class="mb-3">
                        <label for="">Meta Description</label>
                        <textarea name="meta_description" class="form-control" id=""  rows="4">{{$product->meta_description}}</textarea>
                     </div>
                  </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                           <div class="mb-3">
                              ...
                              <input type="text" name="quanlity"  value="{{$product->quanlity}}" class="form-control">
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="mb-3">
                              ...
                              <tr class="prod-color-tr">
                                 ...
                                 <td>
                                    <div class="input-group mb-3" style="width:150px;">
                                       <input type="number" value="{{$prodColor->quanlity}}" class="productColorQuanlity form-control form-control-sm">
...
<script>
   $(document).ready(function(){
      ...
      $(document).on('click', '.updateProductColorBtn', function(){
         ...
         var qty= $(this).closest('.prod-color-tr').find('.productColorQuanlity').val();
         // alert(prod_color_id);

         if(qty <= 0){
            alert ('Quanlity is required');
            return false;
         }
